...
@WebServlet(name = "NewSourceServlet", urlPatterns = "/newsource")
public class NewSourceServlet extends HttpServlet {

    private static Logger LOG = LogManager.getLogger(NewSourceServlet.class);
    ...
    protected void doPost(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
        ...
        DAOFactory.getDAO(DAOType.SOURCE).save(source);
